...
function animateCounters() {
  ...
  let speed = 2000; // Animation speed in milliseconds
...
// Listen for scroll event and animate count when section is in viewport
window.addEventListener('scroll', () => {
  let countSection = document.querySelector('#count');
  if (isElementInViewport(countSection)) {
    animateCounters();
    // Remove event listener to prevent multiple animations
